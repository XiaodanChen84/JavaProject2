...
public class DonationRecordLogic extends GenericLogic<DonationRecord, DonationRecordDAL>{
    ...
    public DonationRecord createEntity(Map<String, String[]> parameterMap) {
        ...
        int personId = Integer.parseInt(parameterMap.get( PERSON_ID)[0].trim());
        int donationId = Integer.parseInt(parameterMap.get( DONATION_ID)[0].trim());
        ...
        validator.accept( date, 19);
        
        entity.setTested( tested);
        entity.setPerson(getPersonForDonationRecord(Integer.parseInt(parameterMap.get(PERSON_ID)[0].trim())));
        entity.setBloodDonation(getBloodDonationForDonationRecord(Integer.parseInt(parameterMap.get(DONATION_ID)[0].trim())));
