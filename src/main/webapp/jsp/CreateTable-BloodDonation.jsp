...
<html>
    ...
    <body>
        ...
        <form method="post">
        BloodBankID:<br>
        <input type="text" name="bank_id" value=""><br>
        <br>
        Milliliters:<br>
        <input type="text" name="milliliters" value=""><br>
        <br>
        Blood Group:<br>
        <input type="text" name="blood_group" value=""><br>
        <br>
        Rh Factor:<br>");
        <input type="text" name="rhesus_factor" value=""><br>
        <br>
